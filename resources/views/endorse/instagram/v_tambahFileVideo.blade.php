                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah File Video</h3>
                        </div>
                        <div class="card-body">
                            <form method="post" action="\storeFileVideo\{{ $endor->id }}" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group mb-3">
                                    <input type="hidden" name="endors_id" id="endors_id" value="{{ $endor->id }}" class="form-control" readonly>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="endors_id" class="mb-3">Nama Endoser</label>
                                    <input type="text" name="" id="endors_id" value="{{ $endor->nm_endorse  }}" class="form-control" readonly>
                                </div>
                                <div class="form-group mb-5">
                                    <label for="file" class="mb-3">Video<span style="color:red">*</span></label>
                                    <input type="file" name="file" id="file" class="form-control">
                                    <label style="font-size: 13px;margin-top:10px">File maksimal 500MB Untuk Video(MP4,MOV)</label>
                                    @if($errors->has('file'))
            ...
            $('form').ajaxForm({
                ...
                complete:function(response){
                    ...
                    Swal.fire({
                            icon: 'success',
                            title: 'Success',
                            text: response.responseJSON.success,
                        });
                    }
                } 
            });
