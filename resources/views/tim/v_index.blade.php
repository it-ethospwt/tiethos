                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-tambahUser mt-2 mb-5">
                                <a href="{{ route('manageTim.tambahTim') }}" class="btn btn-warning btn-pill active">
                                    <span style="margin-right: 8px;"><i class="fa fa-plus"></i></span> Tim Baru
                                </a>
                                    <a href="{{ route('manageTim.tambahAnggota') }}" class="btn btn-outline-primary btn-pill">
                                        <span style="margin-right: 8px;"><i class="fa fa-plus"></i></span> Anggota
                                    </a>
                            </div>
                            <!-- Table -->
                            <table id="table-user" class="display nowrap" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr style="font-size: 90%;">
                                        ...
                                        <td>{{ $d->updated_at }}</td>
                                        <td>
                                            @php $btnDetailShow = false; @endphp
                                                @foreach($d->anggota as $anggota)
                                                    @if(!$btnDetailShow)
                                                        <a href="{{ route('detailTim',['id' => $d->id,'tim_id' => $anggota->tim_id]) }}" class="btn btn-primary btn-pill">
                                                            <span class="ti ti-search" style="color: white;"></span>
                                                        </a>
                                                        @php $btnDetailShow = true @endphp
                                                    @endif
                                                @endforeach
                                            <a href="#"
