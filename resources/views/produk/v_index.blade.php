                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="btn-tambahProduk mt-2 mb-5">
                                <a href="\tambah" class="btn btn-primary"> <span style="margin-right: 8px;"><i class="fa fa-plus"></i></span>
                                    Data Produk</a>
                            </div>
                        ...
                        <tbody>
                            ...
                            <tr style="font-size: 90%;">
                                ...
                                <td>
                                    ...
                                    <a href="edit/{{ $d->id }}" class="btn btn-success btn-pill "><i class="fa fa-edit"> </i></a>
                                    <a href="hapus/{{ $d->id }}" class="btn btn-danger btn-pill"><i class="fa fa-trash"> </i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
