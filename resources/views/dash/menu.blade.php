        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    @endif
                    @if (Auth::check() && (Auth::user()->role == 'Superadmin' || Auth::user()->role == 'ADV'))
                    ...
                    <li
                        class="nav-item dropdown {{ request()->is('kol*') || request()->is('endorse*') || request()->is('affiliator*') ? 'active' : '' }}">
                        ...
                        <div class="dropdown-menu">
                            <div class="dropdown-menu-columns">
                                <div class="dropdown-menu-column">
                                    <a class="dropdown-item {{ request()->is('kol*') ? 'active' : '' }}"
                                        href="{{ route('kol') }}">
                                        Contect KOL
                                    </a>
                                    <a class="dropdown-item {{ request()->is('endorse*') ? 'active' : '' }}"
                                        href="/endorse">
                                        List Endorse
                                    </a>
                                    <a class="dropdown-item {{ request()->is('affiliator*') ? 'active' : '' }}"
                                        href="/affiliator">
                                        List Affiliator
                                    </a>
                                </div>
