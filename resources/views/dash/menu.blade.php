        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    @endif
                    @if (Auth::check() && (Auth::user()->role == 'Superadmin' || Auth::user()->role == 'ADV' || Auth::user()->role == 'Admin Internal' ))
                    ...
                    @endif
                    @if (Auth::check() && (Auth::user()->role == 'Superadmin' || Auth::user()->role == 'ADV' || Auth::user()->role == 'CS' || Auth::user()->role == 'Admin Internal'))
                    ...
                    @endif
                    @if (Auth::check() && Auth::user()->role == 'Superadmin' || Auth::user()->role == 'Admin Internal')
                    <li
                        class="nav-item dropdown {{ request()->is('manageTim') ? 'active' : '' }}">
                        <a class="nav-link" href="{{ route('manageTim.index') }}">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <!-- Download SVG icon from http://tabler-icons.io/i/layout-2 -->
