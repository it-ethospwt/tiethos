                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <form action="{{ route('fbm', $product_id) }}" method="GET">
                                    <div class="input-group mb-3">
                                        ...
                                        <a href="{{ route('konten.ccp', $product_id) }}" class="btn btn-primary">All</a>
                                    </div>
                                </form>
                            </div>
                            <div class="card-header">
                                    ...
                                    <div class="tab-pane active show" id="tabs-home-1">
                                        <div class="row">
                                            <div class="row">
                                                ...
                                                @if (!empty($k->gambar) && $k->konten == "ccp")
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        selectMonth.addEventListener('change', function(event) {
            // Redirect ke rute fbm dengan bulan yang dipilih
            window.location.href = "{{ route('fbm', $product_id) }}?month=" + this.value;
        });
    });
</script>
<script>
